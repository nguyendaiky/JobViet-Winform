...
{
    public partial class Home_GiatUi : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                string id = ShareVar.id_GiatUi.ToString();
                ShareVar.id_GiatUi++;
                ShareVar.data.Rows.Add("Giặt Ủi " + id, ngay, gio, diachi, giotinh, dotuoi, chatluong, gia, phuphi, sogio, "");
